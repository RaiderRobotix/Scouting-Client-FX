...
public class AllianceReport {
     ...
     */
    private String bestAutonGamePieceCombo;
...
//
//        double autonPoints = calculatePredictedAutonPoints();
//        double teleOpPoints = calculatePredictedTeleOpPoints();
//        double endgamePoints = calculatePredictedEndgamePoints();
//        predictedValues.put("totalPoints", autonPoints + teleOpPoints + endgamePoints);
//
...
//    }
     ...
     */
//
//    private double calculatePredictedAutonPoints() {
//        double predictedAutonPoints = 0;
//
//        //TODO look at what these do
//        predictedAutonPoints += calculatePredictedAutonBonus();
//        predictedAutonPoints += calculatePredictedAutonGamePiecePoints();
//
//        predictedValues.put("autonPoints", predictedAutonPoints);
//
//        return predictedAutonPoints;
//    }
     ...
     */
//
//    private double calculatePredictedAutonBonus() {
...
//    private double calculatePredictedAutonGamePiecePoints() {
...
//                bestAutonGamePieceCombo = gamePieceCombo;
//
...
//            }
//        }
//        predictedValues.put("autonGamePiecePoints", bestGamePieceScore);
//
...
//    }
//
//    public String getBestAutonGamePieceCombo() {
//        return bestAutonGamePieceCombo;
//    }
//

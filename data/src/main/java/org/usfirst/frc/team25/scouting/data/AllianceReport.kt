...
class AllianceReport(teamReports: ArrayList<TeamReport>) {
    ...
    private fun calculateStats() {
        ...
        val sandstormPoints = calculatePredictedSandstormPoints()
        val teleOpPoints = calculatePredictedTeleOpPoints()
        val endgamePoints = calculatePredictedEndgamePoints()
     ...
     */
    private fun calculatePredictedSandstormPoints(): Double {
     ...
     */
    private fun calculatePredictedSandstormBonus(): Double {
     ...
     */
    private fun calculatePredictedSandstormGamePiecePoints(): Double {
     ...
     */
    private fun calculatePredictedTeleOpPoints(): Double {
        val teleOpHatches = calculatePredictedTeleOpHatchPanels(false)
     ...
     */
    private fun calculatePredictedTeleOpHatchPanels(rocketRp: Boolean): Double {
...
// We also assume that hatch panels placed during sandstorm will be placed in a bay pre-populated with cargo
     ...
     */
    private fun calculatePredictedEndgamePoints(): Double {
